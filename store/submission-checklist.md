...
- [x] Marketing URL, Support URL, Privacy Policy URL → live at `https://daviddef.github.io/Lexis/` (Pages: main:/docs)
...
- [x] Deploy `docs/` (marketing + privacy + app-ads.txt) to `daviddef.github.io/Lexis/` — done, Pages serves main:/docs
